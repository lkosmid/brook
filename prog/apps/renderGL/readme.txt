...
- This app only works with the GL Brook runtime.

- The "fibble" directory contains support code that wraps some of GL (in an effort to keep the demo small). Not all features are wrapped, however, so the main application still contains some raw GL code.