...
%token <base>       FLOAT FLOAT2 FLOAT3 FLOAT4 FIXED FIXED2 FIXED3 FIXED4 SHORTFIXED SHORTFIXED2 SHORTFIXED3 SHORTFIXED4 DOUBLE DOUBLE2 CHAR CHAR2 CHAR3 CHAR4 UCHAR UCHAR2 UCHAR3 UCHAR4
...
constructor_expr: FLOAT2 LPAREN assign_expr COMMA assign_expr RPAREN
	   ...
	   $$ = (Expression *) NULL;
	    ...
	    Expression *exprs[] = { $3, $5 };
            ...
            delete $6;
                ...
                | CHAR3 LPAREN assign_expr COMMA
		                assign_expr COMMA assign_expr RPAREN
        {
	    Expression *exprs[] = { $3, $5, $7 };
            $$ = new ConstructorExpr($1, exprs, NoLocation);
	    ...
	    Expression *exprs[] = { $3, $5, $7, $9 };
            ...
            delete $10;
                ...
                |UCHAR2 LPAREN assign_expr COMMA assign_expr RPAREN
        {
	    Expression *exprs[] = { $3, $5 };
            $$ = new ConstructorExpr($1, exprs, NoLocation);
            delete $2;
            ...
            delete $6;
                ...
                | UCHAR3 LPAREN assign_expr COMMA
		                assign_expr COMMA assign_expr RPAREN
        {
	    Expression *exprs[] = { $3, $5, $7 };
            $$ = new ConstructorExpr($1, exprs, NoLocation);
            ...
            delete $8;
                ...
                | UCHAR4 LPAREN assign_expr COMMA assign_expr COMMA
		                assign_expr COMMA assign_expr RPAREN
        {
	    Expression *exprs[] = { $3, $5, $7, $9 };
            $$ = new ConstructorExpr($1, exprs, NoLocation);
                ...
                | CHAR4 LPAREN error RPAREN
	{
	   $$ = (Expression *) NULL;
                ...
                | UCHAR2 LPAREN error RPAREN
	{
	   $$ = (Expression *) NULL;
	}
                | UCHAR3 LPAREN error RPAREN
	{
	   $$ = (Expression *) NULL;
	}
                | UCHAR4 LPAREN error RPAREN
	{
	   $$ = (Expression *) NULL;
	}
	;
