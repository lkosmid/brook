...
std::string undecoratedBase(Decl * decl) {
   ...
   if (typemask&BT_Fixed4)
      return "fixed4";
   if (typemask&BT_ShortFixed)
      return "shortfixed";
   if (typemask&BT_ShortFixed2)
      return "shortfixed2";
   if (typemask&BT_ShortFixed3)
      return "shortfixed3";
   ...
   if (typemask&BT_Char4)
      return "char4";
   if (typemask&BT_UChar)
      return "unsigned char";
   if (typemask&BT_UChar2)
      return "uchar2";
   if (typemask&BT_UChar3)
      return "uchar3";
   if (typemask&BT_UChar4)
      return "uchar4";
   return "float";
